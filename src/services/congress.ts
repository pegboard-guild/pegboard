...
export const getRepsByZipcode = async (zipcode: string) => {
  try {
    ...
    const response = await fetch(
      `https://www.googleapis.com/civicinfo/v2/representatives?address=${zipcode}&includeOffices=true&levels=country&roles=legislatorLowerBody&roles=legislatorUpperBody&key=AIzaSyA5VLEbXigRx8W0NW6QckE5Wbr8NxONq5E`
    );
