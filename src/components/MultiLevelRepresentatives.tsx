...
import { EnhancedMember } from '../services/googleCivic';
...
const LevelSection: React.FC<LevelSectionProps> = ({ 
  ...
  const getLevelDescription = () => {
    switch(level) {
      ...
      case 'state': 
        return 'Coming Soon: Track state legislation and votes';
      case 'local': 
        return 'Coming Soon: Track local ordinances and city council votes';
    }
  };
  ...
  return (
    <div className="multi-level-representatives">
      ...
      <div className="data-attribution">
        <p>Official data provided by Google Civic Information API</p>
        <p>Federal voting data from Congress.gov</p>
      </div>
    </div>
  );
};
